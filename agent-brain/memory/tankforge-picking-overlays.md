...
In the TankForge / EB-VESSELS app (`C:\Users\User\Desktop\EB VESSELS AGENT\app`), the #1 recurring bug is **"clicking an element in the 3D view doesn't select it."** The cause is almost always one of two things:
