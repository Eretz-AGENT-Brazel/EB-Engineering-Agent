...
//   2. Python sends command  EB_RUN19
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds19))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp19))]
...
namespace EBAgent
{
    ...
    public class EBApp19 : IExtensionApplication
    {
    ...
    public class ApiCmds19
    {
        ...
        [CommandMethod("EB_RUN19", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
