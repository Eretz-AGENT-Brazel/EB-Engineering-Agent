...
//   2. Python sends command  EB_RUN94
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds94))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp94))]
...
namespace EBAgent
{
    ...
    public class EBApp94 : IExtensionApplication
    {
    ...
    public class ApiCmds94
    {
        ...
        [CommandMethod("EB_RUN94", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
