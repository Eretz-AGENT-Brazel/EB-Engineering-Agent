...
//   2. Python sends command  EB_RUN75
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds75))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp75))]
...
namespace EBAgent
{
    ...
    public class EBApp75 : IExtensionApplication
    {
    ...
    public class ApiCmds75
    {
        ...
        [CommandMethod("EB_RUN75", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
