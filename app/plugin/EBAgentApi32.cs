...
//   2. Python sends command  EB_RUN32
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds32))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp32))]
...
namespace EBAgent
{
    ...
    public class EBApp32 : IExtensionApplication
    {
    ...
    public class ApiCmds32
    {
        ...
        [CommandMethod("EB_RUN32", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
