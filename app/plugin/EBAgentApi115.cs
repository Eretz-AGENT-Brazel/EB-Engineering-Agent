...
//   2. Python sends command  EB_RUN115
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds115))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp115))]
...
namespace EBAgent
{
    ...
    public class EBApp115 : IExtensionApplication
    {
    ...
    public class ApiCmds115
    {
        ...
        [CommandMethod("EB_RUN115", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
