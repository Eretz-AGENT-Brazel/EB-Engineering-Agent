...
//   2. Python sends command  EB_RUN159
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds159))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp159))]
...
namespace EBAgent
{
    ...
    public class EBApp159 : IExtensionApplication
    {
    ...
    public class ApiCmds159
    {
        ...
        [CommandMethod("EB_RUN159", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
