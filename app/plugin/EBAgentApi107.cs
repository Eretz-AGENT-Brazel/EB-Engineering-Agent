...
//   2. Python sends command  EB_RUN107
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds107))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp107))]
...
namespace EBAgent
{
    ...
    public class EBApp107 : IExtensionApplication
    {
    ...
    public class ApiCmds107
    {
        ...
        [CommandMethod("EB_RUN107", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
