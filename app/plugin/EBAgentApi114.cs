...
//   2. Python sends command  EB_RUN114
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds114))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp114))]
...
namespace EBAgent
{
    ...
    public class EBApp114 : IExtensionApplication
    {
    ...
    public class ApiCmds114
    {
        ...
        [CommandMethod("EB_RUN114", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
