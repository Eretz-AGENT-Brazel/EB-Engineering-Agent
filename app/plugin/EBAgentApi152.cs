...
//   2. Python sends command  EB_RUN152
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds152))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp152))]
...
namespace EBAgent
{
    ...
    public class EBApp152 : IExtensionApplication
    {
    ...
    public class ApiCmds152
    {
        ...
        [CommandMethod("EB_RUN152", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
