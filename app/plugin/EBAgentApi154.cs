...
//   2. Python sends command  EB_RUN154
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds154))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp154))]
...
namespace EBAgent
{
    ...
    public class EBApp154 : IExtensionApplication
    {
    ...
    public class ApiCmds154
    {
        ...
        [CommandMethod("EB_RUN154", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
