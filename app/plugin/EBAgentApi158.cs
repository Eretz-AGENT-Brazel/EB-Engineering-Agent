...
//   2. Python sends command  EB_RUN158
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds158))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp158))]
...
namespace EBAgent
{
    ...
    public class EBApp158 : IExtensionApplication
    {
    ...
    public class ApiCmds158
    {
        ...
        [CommandMethod("EB_RUN158", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
