...
//   2. Python sends command  EB_RUN106
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds106))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp106))]
...
namespace EBAgent
{
    ...
    public class EBApp106 : IExtensionApplication
    {
    ...
    public class ApiCmds106
    {
        ...
        [CommandMethod("EB_RUN106", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
