...
//   2. Python sends command  EB_RUN110
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds110))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp110))]
...
namespace EBAgent
{
    ...
    public class EBApp110 : IExtensionApplication
    {
    ...
    public class ApiCmds110
    {
        ...
        [CommandMethod("EB_RUN110", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
