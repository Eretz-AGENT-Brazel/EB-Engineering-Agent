...
//   2. Python sends command  EB_RUN60
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds60))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp60))]
...
namespace EBAgent
{
    ...
    public class EBApp60 : IExtensionApplication
    {
    ...
    public class ApiCmds60
    {
        ...
        [CommandMethod("EB_RUN60", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
