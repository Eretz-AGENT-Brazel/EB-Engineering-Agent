...
//   2. Python sends command  EB_RUN178
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds178))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp178))]
...
namespace EBAgent
{
    ...
    public class EBApp178 : IExtensionApplication
    {
    ...
    public class ApiCmds178
    {
        ...
        [CommandMethod("EB_RUN178", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
