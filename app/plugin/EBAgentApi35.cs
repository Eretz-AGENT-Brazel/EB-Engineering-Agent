...
//   2. Python sends command  EB_RUN35
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds35))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp35))]
...
namespace EBAgent
{
    ...
    public class EBApp35 : IExtensionApplication
    {
    ...
    public class ApiCmds35
    {
        ...
        [CommandMethod("EB_RUN35", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
