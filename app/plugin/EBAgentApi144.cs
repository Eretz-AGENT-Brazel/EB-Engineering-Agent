...
//   2. Python sends command  EB_RUN144
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds144))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp144))]
...
namespace EBAgent
{
    ...
    public class EBApp144 : IExtensionApplication
    {
    ...
    public class ApiCmds144
    {
        ...
        [CommandMethod("EB_RUN144", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        static readonly Dictionary<string, string> OpKeys = new Dictionary<string, string>()
        {
            ...
            { "solid", "|at|axis1|axis2|center|ex|ey|h|inner|kind|l|layer|len|normal|oi1|oi2|oo1|oo2|outer|p1|p2|pts|r|r1|r2|rev|taper|twist|w|" },
