...
//   2. Python sends command  EB_RUN81
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds81))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp81))]
...
namespace EBAgent
{
    ...
    public class EBApp81 : IExtensionApplication
    {
    ...
    public class ApiCmds81
    {
        ...
        [CommandMethod("EB_RUN81", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
