...
//   2. Python sends command  EB_RUN175
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds175))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp175))]
...
namespace EBAgent
{
    ...
    public class EBApp175 : IExtensionApplication
    {
    ...
    public class ApiCmds175
    {
        ...
        [CommandMethod("EB_RUN175", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
