...
//   2. Python sends command  EB_RUN138
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds138))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp138))]
...
namespace EBAgent
{
    ...
    public class EBApp138 : IExtensionApplication
    {
    ...
    public class ApiCmds138
    {
        ...
        [CommandMethod("EB_RUN138", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
