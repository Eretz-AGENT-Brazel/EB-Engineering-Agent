...
//   2. Python sends command  EB_RUN62
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds62))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp62))]
...
namespace EBAgent
{
    ...
    public class EBApp62 : IExtensionApplication
    {
    ...
    public class ApiCmds62
    {
        ...
        [CommandMethod("EB_RUN62", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
