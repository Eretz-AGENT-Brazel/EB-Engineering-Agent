...
//   2. Python sends command  EB_RUN43
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds43))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp43))]
...
namespace EBAgent
{
    ...
    public class EBApp43 : IExtensionApplication
    {
    ...
    public class ApiCmds43
    {
        ...
        [CommandMethod("EB_RUN43", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
