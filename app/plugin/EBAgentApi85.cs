...
//   2. Python sends command  EB_RUN85
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds85))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp85))]
...
namespace EBAgent
{
    ...
    public class EBApp85 : IExtensionApplication
    {
    ...
    public class ApiCmds85
    {
        ...
        [CommandMethod("EB_RUN85", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void Section(Dictionary<string, string> kv)
        {
            ...
            try
            {
                ...
                int els = geo.lineCount + geo.arcCount + geo.circleCount;
