...
//   2. Python sends command  EB_RUN84
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds84))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp84))]
...
namespace EBAgent
{
    ...
    public class EBApp84 : IExtensionApplication
    {
    ...
    public class ApiCmds84
    {
        ...
        [CommandMethod("EB_RUN84", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
