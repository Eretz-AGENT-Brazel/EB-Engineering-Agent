...
//   2. Python sends command  EB_RUN112
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds112))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp112))]
...
namespace EBAgent
{
    ...
    public class EBApp112 : IExtensionApplication
    {
    ...
    public class ApiCmds112
    {
        ...
        [CommandMethod("EB_RUN112", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void Cope(Dictionary<string, string> kv)
        {
            ...
            long sId = IdFromHandle(Get(kv, "support", ""));
