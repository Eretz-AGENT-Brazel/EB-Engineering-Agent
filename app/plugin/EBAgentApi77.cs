...
//   2. Python sends command  EB_RUN77
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds77))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp77))]
...
namespace EBAgent
{
    ...
    public class EBApp77 : IExtensionApplication
    {
    ...
    public class ApiCmds77
    {
        ...
        [CommandMethod("EB_RUN77", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
