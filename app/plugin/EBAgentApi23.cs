...
//   2. Python sends command  EB_RUN23
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds23))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp23))]
...
namespace EBAgent
{
    ...
    public class EBApp23 : IExtensionApplication
    {
    ...
    public class ApiCmds23
    {
        ...
        [CommandMethod("EB_RUN23", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
