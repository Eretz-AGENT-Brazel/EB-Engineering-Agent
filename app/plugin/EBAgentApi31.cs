...
//   2. Python sends command  EB_RUN31
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds31))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp31))]
...
namespace EBAgent
{
    ...
    public class EBApp31 : IExtensionApplication
    {
    ...
    public class ApiCmds31
    {
        ...
        [CommandMethod("EB_RUN31", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
