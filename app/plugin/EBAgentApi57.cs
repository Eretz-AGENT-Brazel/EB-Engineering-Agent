...
//   2. Python sends command  EB_RUN57
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds57))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp57))]
...
namespace EBAgent
{
    ...
    public class EBApp57 : IExtensionApplication
    {
    ...
    public class ApiCmds57
    {
        ...
        [CommandMethod("EB_RUN57", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
