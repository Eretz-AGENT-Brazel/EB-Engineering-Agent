...
//   2. Python sends command  EB_RUN65
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds65))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp65))]
...
namespace EBAgent
{
    ...
    public class EBApp65 : IExtensionApplication
    {
    ...
    public class ApiCmds65
    {
        ...
        [CommandMethod("EB_RUN65", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
