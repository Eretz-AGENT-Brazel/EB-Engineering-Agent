...
//   2. Python sends command  EB_RUN22
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds22))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp22))]
...
namespace EBAgent
{
    ...
    public class EBApp22 : IExtensionApplication
    {
    ...
    public class ApiCmds22
    {
        ...
        [CommandMethod("EB_RUN22", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
