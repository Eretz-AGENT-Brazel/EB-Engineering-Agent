...
//   2. Python sends command  EB_RUN63
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds63))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp63))]
...
namespace EBAgent
{
    ...
    public class EBApp63 : IExtensionApplication
    {
    ...
    public class ApiCmds63
    {
        ...
        [CommandMethod("EB_RUN63", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
