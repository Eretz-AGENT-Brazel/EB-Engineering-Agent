...
//   2. Python sends command  EB_RUN102
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds102))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp102))]
...
namespace EBAgent
{
    ...
    public class EBApp102 : IExtensionApplication
    {
    ...
    public class ApiCmds102
    {
        ...
        [CommandMethod("EB_RUN102", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
