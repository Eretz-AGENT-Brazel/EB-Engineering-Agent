...
//   2. Python sends command  EB_RUN71
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds71))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp71))]
...
namespace EBAgent
{
    ...
    public class EBApp71 : IExtensionApplication
    {
    ...
    public class ApiCmds71
    {
        ...
        [CommandMethod("EB_RUN71", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
