...
//   2. Python sends command  EB_RUN53
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds53))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp53))]
...
namespace EBAgent
{
    ...
    public class EBApp53 : IExtensionApplication
    {
    ...
    public class ApiCmds53
    {
        ...
        [CommandMethod("EB_RUN53", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void CloneDrills(Dictionary<string, string> kv)
        {
            ...
            try
            {
                ...
                PsDrillObject d = new PsDrillObject();
                d.SetToDefaults();
                d.SetObjectId(src);                  // some ops need the subject set first
                d.TakeoverDrills(sSrc, sTgt);        // Void -> silent
            }
