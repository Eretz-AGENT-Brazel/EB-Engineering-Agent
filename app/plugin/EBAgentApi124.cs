...
//   2. Python sends command  EB_RUN124
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds124))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp124))]
...
namespace EBAgent
{
    ...
    public class EBApp124 : IExtensionApplication
    {
    ...
    public class ApiCmds124
    {
        ...
        [CommandMethod("EB_RUN124", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
