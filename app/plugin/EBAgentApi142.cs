...
//   2. Python sends command  EB_RUN142
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds142))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp142))]
...
namespace EBAgent
{
    ...
    public class EBApp142 : IExtensionApplication
    {
    ...
    public class ApiCmds142
    {
        ...
        [CommandMethod("EB_RUN142", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
