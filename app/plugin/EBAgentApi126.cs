...
//   2. Python sends command  EB_RUN126
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds126))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp126))]
...
namespace EBAgent
{
    ...
    public class EBApp126 : IExtensionApplication
    {
    ...
    public class ApiCmds126
    {
        ...
        [CommandMethod("EB_RUN126", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
