...
//   2. Python sends command  EB_RUN145
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds145))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp145))]
...
namespace EBAgent
{
    ...
    public class EBApp145 : IExtensionApplication
    {
    ...
    public class ApiCmds145
    {
        ...
        [CommandMethod("EB_RUN145", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
