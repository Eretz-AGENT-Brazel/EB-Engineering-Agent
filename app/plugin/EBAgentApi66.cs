...
//   2. Python sends command  EB_RUN66
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds66))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp66))]
...
namespace EBAgent
{
    ...
    public class EBApp66 : IExtensionApplication
    {
    ...
    public class ApiCmds66
    {
        ...
        [CommandMethod("EB_RUN66", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
