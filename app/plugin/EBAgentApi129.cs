...
//   2. Python sends command  EB_RUN129
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds129))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp129))]
...
namespace EBAgent
{
    ...
    public class EBApp129 : IExtensionApplication
    {
    ...
    public class ApiCmds129
    {
        ...
        [CommandMethod("EB_RUN129", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
