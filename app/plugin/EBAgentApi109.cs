...
//   2. Python sends command  EB_RUN109
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds109))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp109))]
...
namespace EBAgent
{
    ...
    public class EBApp109 : IExtensionApplication
    {
    ...
    public class ApiCmds109
    {
        ...
        [CommandMethod("EB_RUN109", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        static readonly Dictionary<string, string> OpKeys = new Dictionary<string, string>()
        {
            ...
            { "ping", "||" },
            { "bracing", "|angle|cat|centerhole|cross|divideall|dm|dynamic|edgeborder|edgehole|ex|ey|group|holecross|holeedge|holehole|host1|host2|layout|mirror|ncross|nogussets|nprof|origin|p1|p2|plateside|platethick|platetype|platewide|play|roundto|shapedist|shapetype|shorten|size|sym|type|prerecalc|welded|" },
            { "weldstyles", "||" },
