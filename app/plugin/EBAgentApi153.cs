...
//   2. Python sends command  EB_RUN153
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds153))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp153))]
...
namespace EBAgent
{
    ...
    public class EBApp153 : IExtensionApplication
    {
    ...
    public class ApiCmds153
    {
        ...
        [CommandMethod("EB_RUN153", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void StyleList(Dictionary<string, string> kv)
        {
            ...
            try
            {
                ...
                try { PsObjectStyleList l2 = new PsObjectStyleList();
                      ...
                      l2.Initialize(); after = l2.Count; } catch { }
