...
//   2. Python sends command  EB_RUN52
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds52))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp52))]
...
namespace EBAgent
{
    ...
    public class EBApp52 : IExtensionApplication
    {
    ...
    public class ApiCmds52
    {
        ...
        [CommandMethod("EB_RUN52", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
