...
//   2. Python sends command  EB_RUN149
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds149))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp149))]
...
namespace EBAgent
{
    ...
    public class EBApp149 : IExtensionApplication
    {
    ...
    public class ApiCmds149
    {
        ...
        [CommandMethod("EB_RUN149", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
