...
//   2. Python sends command  EB_RUN49
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds49))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp49))]
...
namespace EBAgent
{
    ...
    public class EBApp49 : IExtensionApplication
    {
    ...
    public class ApiCmds49
    {
        ...
        [CommandMethod("EB_RUN49", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void PosSet(Dictionary<string, string> kv)
        {
            ...
            try
            {
                ...
                if (rcRead == 0)
                { Result("EB_ERR posset: readFrom returned 0 for handle=" + h + " -- refused"); return; }
