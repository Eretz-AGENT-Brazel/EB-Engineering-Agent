...
//   2. Python sends command  EB_RUN97
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds97))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp97))]
...
namespace EBAgent
{
    ...
    public class EBApp97 : IExtensionApplication
    {
    ...
    public class ApiCmds97
    {
        ...
        [CommandMethod("EB_RUN97", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
