...
//   2. Python sends command  EB_RUN78
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds78))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp78))]
...
namespace EBAgent
{
    ...
    public class EBApp78 : IExtensionApplication
    {
    ...
    public class ApiCmds78
    {
        ...
        [CommandMethod("EB_RUN78", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
