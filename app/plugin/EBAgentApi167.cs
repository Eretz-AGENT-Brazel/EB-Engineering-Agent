...
//   2. Python sends command  EB_RUN167
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds167))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp167))]
...
namespace EBAgent
{
    ...
    public class EBApp167 : IExtensionApplication
    {
    ...
    public class ApiCmds167
    {
        ...
        [CommandMethod("EB_RUN167", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
