...
//   2. Python sends command  EB_RUN108
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds108))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp108))]
...
namespace EBAgent
{
    ...
    public class EBApp108 : IExtensionApplication
    {
    ...
    public class ApiCmds108
    {
        ...
        [CommandMethod("EB_RUN108", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void Bracing(Dictionary<string, string> kv)
        {
            ...
            try
            {
                ...
                // the bracing bar section: catalogue + size (the manual's three boxes)
        ...
        static readonly Dictionary<string, string> OpKeys = new Dictionary<string, string>()
        {
            ...
            { "ping", "||" },
            { "bracing", "|angle|cat|centerhole|cross|divideall|dm|dynamic|edgeborder|edgehole|ex|ey|group|holecross|holeedge|holehole|host1|host2|layout|mirror|ncross|nogussets|nprof|origin|p1|p2|plateside|platethick|platetype|platewide|play|roundto|shapedist|shorten|size|sym|type|welded|" },
            { "weldstyles", "||" },
