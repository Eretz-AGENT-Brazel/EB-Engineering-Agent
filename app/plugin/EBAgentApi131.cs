...
//   2. Python sends command  EB_RUN131
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds131))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp131))]
...
namespace EBAgent
{
    ...
    public class EBApp131 : IExtensionApplication
    {
    ...
    public class ApiCmds131
    {
        ...
        [CommandMethod("EB_RUN131", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
