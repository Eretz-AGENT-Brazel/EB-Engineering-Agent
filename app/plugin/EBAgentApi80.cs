...
//   2. Python sends command  EB_RUN80
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds80))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp80))]
...
namespace EBAgent
{
    ...
    public class EBApp80 : IExtensionApplication
    {
    ...
    public class ApiCmds80
    {
        ...
        [CommandMethod("EB_RUN80", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        static readonly Dictionary<string, string> OpKeys = new Dictionary<string, string>()
        {
            ...
            { "ping", "||" },
            { "save", "|as|" },
            { "connset", "|at|beam|set|support|template|" },
