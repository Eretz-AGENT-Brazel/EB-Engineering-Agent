...
//   2. Python sends command  EB_RUN137
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds137))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp137))]
...
namespace EBAgent
{
    ...
    public class EBApp137 : IExtensionApplication
    {
    ...
    public class ApiCmds137
    {
        ...
        [CommandMethod("EB_RUN137", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
