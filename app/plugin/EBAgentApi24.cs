...
//   2. Python sends command  EB_RUN24
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds24))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp24))]
...
namespace EBAgent
{
    ...
    public class EBApp24 : IExtensionApplication
    {
    ...
    public class ApiCmds24
    {
        ...
        [CommandMethod("EB_RUN24", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
