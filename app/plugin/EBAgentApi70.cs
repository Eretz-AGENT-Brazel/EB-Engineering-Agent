...
//   2. Python sends command  EB_RUN70
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds70))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp70))]
...
namespace EBAgent
{
    ...
    public class EBApp70 : IExtensionApplication
    {
    ...
    public class ApiCmds70
    {
        ...
        [CommandMethod("EB_RUN70", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void DetailCut(Dictionary<string, string> kv)
        {
            ...
            string after = ModSig(oid);
            Result("EB_OK detailcut handle=" + hh + " depth=" + F(depth) + " applyRc=" + rc +
                   " mods[" + before + "]->[" + after + "]" +
                   "  (a detail cut removes NO material -- it marks a 2D section for detailing)" + msg);
        }
