...
//   2. Python sends command  EB_RUN44
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds44))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp44))]
...
namespace EBAgent
{
    ...
    public class EBApp44 : IExtensionApplication
    {
    ...
    public class ApiCmds44
    {
        ...
        [CommandMethod("EB_RUN44", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
