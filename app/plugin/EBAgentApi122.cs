...
//   2. Python sends command  EB_RUN122
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds122))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp122))]
...
namespace EBAgent
{
    ...
    public class EBApp122 : IExtensionApplication
    {
    ...
    public class ApiCmds122
    {
        ...
        [CommandMethod("EB_RUN122", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
