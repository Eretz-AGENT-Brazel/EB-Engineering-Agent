...
//   2. Python sends command  EB_RUN76
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds76))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp76))]
...
namespace EBAgent
{
    ...
    public class EBApp76 : IExtensionApplication
    {
    ...
    public class ApiCmds76
    {
        ...
        [CommandMethod("EB_RUN76", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
