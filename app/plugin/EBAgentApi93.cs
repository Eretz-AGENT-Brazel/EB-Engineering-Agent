...
//   2. Python sends command  EB_RUN93
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds93))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp93))]
...
namespace EBAgent
{
    ...
    public class EBApp93 : IExtensionApplication
    {
    ...
    public class ApiCmds93
    {
        ...
        [CommandMethod("EB_RUN93", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
