...
//   2. Python sends command  EB_RUN92
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds92))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp92))]
...
namespace EBAgent
{
    ...
    public class EBApp92 : IExtensionApplication
    {
    ...
    public class ApiCmds92
    {
        ...
        [CommandMethod("EB_RUN92", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        static readonly Dictionary<string, string> OpKeys = new Dictionary<string, string>()
        {
            ...
            { "ping", "||" },
            { "frame", "|at|axisnames|backclip|base|d3|frontclip|hsteps|lock|lsteps|name|ridgeheight|ridgewidth|roofangle|segments|top|views|wsteps|" },
            { "frameinfo", "|handle|" },
