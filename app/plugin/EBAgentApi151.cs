...
//   2. Python sends command  EB_RUN151
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds151))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp151))]
...
namespace EBAgent
{
    ...
    public class EBApp151 : IExtensionApplication
    {
    ...
    public class ApiCmds151
    {
        ...
        [CommandMethod("EB_RUN151", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
