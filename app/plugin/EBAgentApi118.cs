...
//   2. Python sends command  EB_RUN118
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds118))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp118))]
...
namespace EBAgent
{
    ...
    public class EBApp118 : IExtensionApplication
    {
    ...
    public class ApiCmds118
    {
        ...
        [CommandMethod("EB_RUN118", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void MacroBrace(Dictionary<string, string> kv)
        {
            ...
            try
            {
                ...
                long connId = 0;
                try { connId = uc.InitialCall(); sb.AppendLine("  InitialCall -> " + connId); }
                catch (System.Exception e) { sb.AppendLine("  InitialCall !" + One(e.Message)); }
