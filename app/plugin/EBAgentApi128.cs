...
//   2. Python sends command  EB_RUN128
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds128))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp128))]
...
namespace EBAgent
{
    ...
    public class EBApp128 : IExtensionApplication
    {
    ...
    public class ApiCmds128
    {
        ...
        [CommandMethod("EB_RUN128", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
