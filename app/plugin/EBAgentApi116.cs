...
//   2. Python sends command  EB_RUN116
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds116))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp116))]
...
namespace EBAgent
{
    ...
    public class EBApp116 : IExtensionApplication
    {
    ...
    public class ApiCmds116
    {
        ...
        [CommandMethod("EB_RUN116", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
