...
//   2. Python sends command  EB_RUN54
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds54))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp54))]
...
namespace EBAgent
{
    ...
    public class EBApp54 : IExtensionApplication
    {
    ...
    public class ApiCmds54
    {
        ...
        [CommandMethod("EB_RUN54", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
