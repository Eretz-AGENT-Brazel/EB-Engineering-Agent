...
//   2. Python sends command  EB_RUN125
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds125))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp125))]
...
namespace EBAgent
{
    ...
    public class EBApp125 : IExtensionApplication
    {
    ...
    public class ApiCmds125
    {
        ...
        [CommandMethod("EB_RUN125", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
