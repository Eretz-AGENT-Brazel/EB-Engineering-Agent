...
//   2. Python sends command  EB_RUN113
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds113))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp113))]
...
namespace EBAgent
{
    ...
    public class EBApp113 : IExtensionApplication
    {
    ...
    public class ApiCmds113
    {
        ...
        [CommandMethod("EB_RUN113", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
