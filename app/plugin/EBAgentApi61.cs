...
//   2. Python sends command  EB_RUN61
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds61))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp61))]
...
namespace EBAgent
{
    ...
    public class EBApp61 : IExtensionApplication
    {
    ...
    public class ApiCmds61
    {
        ...
        [CommandMethod("EB_RUN61", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void Collision(Dictionary<string, string> kv)
        {
            ...
            try
            {
                ...
                if (boxS.Length > 0)
                {
                    ...
                    selCount = sel.SelectAllObjectsInRange(true, false, false, Pt(pp[0]), Pt(pp[1]));
                }
                else selCount = sel.SelectAllObjects(true, false, false);
            ...
            Result((bodyCount == 0 && created.Count == 0 ? "EB_OK" : "EB_OK") +
                   ...
                   (created.Count > 0 ? " at=" + string.Join(",", created.ToArray()) : "") + msg);
        }
