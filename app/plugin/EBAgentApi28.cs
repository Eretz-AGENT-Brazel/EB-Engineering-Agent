...
//   2. Python sends command  EB_RUN28
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds28))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp28))]
...
namespace EBAgent
{
    ...
    public class EBApp28 : IExtensionApplication
    {
    ...
    public class ApiCmds28
    {
        ...
        [CommandMethod("EB_RUN28", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
