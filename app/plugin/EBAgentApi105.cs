...
//   2. Python sends command  EB_RUN105
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds105))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp105))]
...
namespace EBAgent
{
    ...
    public class EBApp105 : IExtensionApplication
    {
    ...
    public class ApiCmds105
    {
        ...
        [CommandMethod("EB_RUN105", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
