...
//   2. Python sends command  EB_RUN90
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds90))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp90))]
...
namespace EBAgent
{
    ...
    public class EBApp90 : IExtensionApplication
    {
    ...
    public class ApiCmds90
    {
        ...
        [CommandMethod("EB_RUN90", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
