...
//   2. Python sends command  EB_RUN38
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds38))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp38))]
...
namespace EBAgent
{
    ...
    public class EBApp38 : IExtensionApplication
    {
    ...
    public class ApiCmds38
    {
        ...
        [CommandMethod("EB_RUN38", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
