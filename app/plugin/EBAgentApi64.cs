...
//   2. Python sends command  EB_RUN64
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds64))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp64))]
...
namespace EBAgent
{
    ...
    public class EBApp64 : IExtensionApplication
    {
    ...
    public class ApiCmds64
    {
        ...
        [CommandMethod("EB_RUN64", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
