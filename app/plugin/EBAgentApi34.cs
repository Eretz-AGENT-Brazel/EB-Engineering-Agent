...
//   2. Python sends command  EB_RUN34
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds34))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp34))]
...
namespace EBAgent
{
    ...
    public class EBApp34 : IExtensionApplication
    {
    ...
    public class ApiCmds34
    {
        ...
        [CommandMethod("EB_RUN34", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
