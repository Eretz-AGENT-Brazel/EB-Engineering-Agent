...
//   2. Python sends command  EB_RUN26
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds26))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp26))]
...
namespace EBAgent
{
    ...
    public class EBApp26 : IExtensionApplication
    {
    ...
    public class ApiCmds26
    {
        ...
        [CommandMethod("EB_RUN26", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void Replicate(Dictionary<string, string> kv)
        {
            ...
            if (picked == 0) { Result("EB_ERR replicate: nothing inside the box"); return; }
