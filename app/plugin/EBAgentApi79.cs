...
//   2. Python sends command  EB_RUN79
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds79))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp79))]
...
namespace EBAgent
{
    ...
    public class EBApp79 : IExtensionApplication
    {
    ...
    public class ApiCmds79
    {
        ...
        [CommandMethod("EB_RUN79", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
