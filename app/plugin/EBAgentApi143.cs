...
//   2. Python sends command  EB_RUN143
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds143))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp143))]
...
namespace EBAgent
{
    ...
    public class EBApp143 : IExtensionApplication
    {
    ...
    public class ApiCmds143
    {
        ...
        [CommandMethod("EB_RUN143", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
