...
//   2. Python sends command  EB_RUN47
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds47))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp47))]
...
namespace EBAgent
{
    ...
    public class EBApp47 : IExtensionApplication
    {
    ...
    public class ApiCmds47
    {
        ...
        [CommandMethod("EB_RUN47", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
