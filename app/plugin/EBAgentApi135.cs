...
//   2. Python sends command  EB_RUN135
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds135))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp135))]
...
namespace EBAgent
{
    ...
    public class EBApp135 : IExtensionApplication
    {
    ...
    public class ApiCmds135
    {
        ...
        [CommandMethod("EB_RUN135", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
