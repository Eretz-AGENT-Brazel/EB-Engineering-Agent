...
//   2. Python sends command  EB_RUN117
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds117))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp117))]
...
namespace EBAgent
{
    ...
    public class EBApp117 : IExtensionApplication
    {
    ...
    public class ApiCmds117
    {
        ...
        [CommandMethod("EB_RUN117", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
