...
//   2. Python sends command  EB_RUN73
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds73))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp73))]
...
namespace EBAgent
{
    ...
    public class EBApp73 : IExtensionApplication
    {
    ...
    public class ApiCmds73
    {
        ...
        [CommandMethod("EB_RUN73", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
