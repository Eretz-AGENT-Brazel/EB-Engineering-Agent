...
//   2. Python sends command  EB_RUN30
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds30))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp30))]
...
namespace EBAgent
{
    ...
    public class EBApp30 : IExtensionApplication
    {
    ...
    public class ApiCmds30
    {
        ...
        [CommandMethod("EB_RUN30", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
