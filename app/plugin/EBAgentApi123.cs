...
//   2. Python sends command  EB_RUN123
...
using Bentley.ProStructures.Steel.Primitive;   // v123: PsCreatePrimitive (B.10 solids)
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds123))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp123))]
...
namespace EBAgent
{
    ...
    public class EBApp123 : IExtensionApplication
    {
    ...
    public class ApiCmds123
    {
        ...
        [CommandMethod("EB_RUN123", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
