...
//   2. Python sends command  EB_RUN51
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds51))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp51))]
...
namespace EBAgent
{
    ...
    public class EBApp51 : IExtensionApplication
    {
    ...
    public class ApiCmds51
    {
        ...
        [CommandMethod("EB_RUN51", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
