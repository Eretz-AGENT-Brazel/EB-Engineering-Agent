...
//   2. Python sends command  EB_RUN72
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds72))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp72))]
...
namespace EBAgent
{
    ...
    public class EBApp72 : IExtensionApplication
    {
    ...
    public class ApiCmds72
    {
        ...
        [CommandMethod("EB_RUN72", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void Section(Dictionary<string, string> kv)
        {
            ...
            try
            {
                ...
                geo.CreateSection(oid, at,
                                  ...
                                  project, ModelBuild.kBuildModel);
                StringBuilder sb = new StringBuilder();
                ...
                Result((geo.isEmpty() ? "EB_ERR" : "EB_OK") + " section handle=" + hh + " " + sb.ToString());
            }
        ...
        static readonly Dictionary<string, string> OpKeys = new Dictionary<string, string>()
        {
            ...
            { "ping", "||" },
            { "section", "|at|handle|project|xaxis|yaxis|" },
