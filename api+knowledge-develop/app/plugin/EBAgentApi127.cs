...
//   2. Python sends command  EB_RUN127
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds127))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp127))]
...
namespace EBAgent
{
    ...
    public class EBApp127 : IExtensionApplication
    {
    ...
    public class ApiCmds127
    {
        ...
        [CommandMethod("EB_RUN127", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
