...
//   2. Python sends command  EB_RUN45
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds45))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp45))]
...
namespace EBAgent
{
    ...
    public class EBApp45 : IExtensionApplication
    {
    ...
    public class ApiCmds45
    {
        ...
        [CommandMethod("EB_RUN45", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void Chamfer(Dictionary<string, string> kv)
        {
            ...
            try
            {
                ...
                if (atS.Length > 0)
                {
                    // pick the corner by point -- the manual's way of selecting a corner
