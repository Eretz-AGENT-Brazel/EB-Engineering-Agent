...
//   2. Python sends command  EB_RUN74
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds74))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp74))]
...
namespace EBAgent
{
    ...
    public class EBApp74 : IExtensionApplication
    {
    ...
    public class ApiCmds74
    {
        ...
        [CommandMethod("EB_RUN74", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
