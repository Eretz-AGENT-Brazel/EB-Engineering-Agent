...
//   2. Python sends command  EB_RUN50
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds50))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp50))]
...
namespace EBAgent
{
    ...
    public class EBApp50 : IExtensionApplication
    {
    ...
    public class ApiCmds50
    {
        ...
        [CommandMethod("EB_RUN50", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
