...
//   2. Python sends command  EB_RUN141
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds141))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp141))]
...
namespace EBAgent
{
    ...
    public class EBApp141 : IExtensionApplication
    {
    ...
    public class ApiCmds141
    {
        ...
        [CommandMethod("EB_RUN141", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
