...
//   2. Python sends command  EB_RUN33
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds33))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp33))]
...
namespace EBAgent
{
    ...
    public class EBApp33 : IExtensionApplication
    {
    ...
    public class ApiCmds33
    {
        ...
        [CommandMethod("EB_RUN33", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
