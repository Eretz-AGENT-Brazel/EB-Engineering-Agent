...
//   2. Python sends command  EB_RUN133
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds133))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp133))]
...
namespace EBAgent
{
    ...
    public class EBApp133 : IExtensionApplication
    {
    ...
    public class ApiCmds133
    {
        ...
        [CommandMethod("EB_RUN133", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
