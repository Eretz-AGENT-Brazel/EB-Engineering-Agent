...
//   2. Python sends command  EB_RUN96
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds96))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp96))]
...
namespace EBAgent
{
    ...
    public class EBApp96 : IExtensionApplication
    {
    ...
    public class ApiCmds96
    {
        ...
        [CommandMethod("EB_RUN96", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
            ...
            string[] wanted = (probe == "safe")
                ...
                : (probe == "all"
                    ? new string[] { "thickness","inserth","insertxy","weight","dimension","paint",
                                     "dimalign","dimdir","name","nametpl","poly","crosscheck",
