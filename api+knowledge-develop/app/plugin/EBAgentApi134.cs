...
//   2. Python sends command  EB_RUN134
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds134))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp134))]
...
namespace EBAgent
{
    ...
    public class EBApp134 : IExtensionApplication
    {
    ...
    public class ApiCmds134
    {
        ...
        [CommandMethod("EB_RUN134", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        // op=vfy_fit [minx=] [maxx=] [tol=12] [maxspare=45] [minspare=15]
        //
        ...
        void VfyFit(Dictionary<string, string> kv)
        {
            ...
            StringBuilder sb = new StringBuilder();
            sb.AppendLine("verdict\tbolt\tname\tnominal\tpacket\tspare\tklemm\tholes\towners");
            int ok = 0, noHole = 0, over = 0, under = 0, unknown = 0;
        ...
        static readonly Dictionary<string, string> OpKeys = new Dictionary<string, string>()
        {
            ...
            { "vfy_fit", "|maxx|minx|tol|maxspare|minspare|" },
