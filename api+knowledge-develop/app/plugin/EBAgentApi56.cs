...
//   2. Python sends command  EB_RUN56
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds56))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp56))]
...
namespace EBAgent
{
    ...
    public class EBApp56 : IExtensionApplication
    {
    ...
    public class ApiCmds56
    {
        ...
        [CommandMethod("EB_RUN56", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
