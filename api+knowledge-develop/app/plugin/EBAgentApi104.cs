...
//   2. Python sends command  EB_RUN104
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds104))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp104))]
...
namespace EBAgent
{
    ...
    public class EBApp104 : IExtensionApplication
    {
    ...
    public class ApiCmds104
    {
        ...
        [CommandMethod("EB_RUN104", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
