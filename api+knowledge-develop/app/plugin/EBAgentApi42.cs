...
//   2. Python sends command  EB_RUN42
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds42))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp42))]
...
namespace EBAgent
{
    ...
    public class EBApp42 : IExtensionApplication
    {
    ...
    public class ApiCmds42
    {
        ...
        [CommandMethod("EB_RUN42", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
