...
//   2. Python sends command  EB_RUN82
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds82))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp82))]
...
namespace EBAgent
{
    ...
    public class EBApp82 : IExtensionApplication
    {
    ...
    public class ApiCmds82
    {
        ...
        [CommandMethod("EB_RUN82", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
