...
//   2. Python sends command  EB_RUN130
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds130))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp130))]
...
namespace EBAgent
{
    ...
    public class EBApp130 : IExtensionApplication
    {
    ...
    public class ApiCmds130
    {
        ...
        [CommandMethod("EB_RUN130", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
