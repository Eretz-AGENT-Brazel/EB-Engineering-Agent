...
//   2. Python sends command  EB_RUN176
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds176))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp176))]
...
namespace EBAgent
{
    ...
    public class EBApp176 : IExtensionApplication
    {
    ...
    public class ApiCmds176
    {
        ...
        [CommandMethod("EB_RUN176", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void Bind(Dictionary<string, string> kv)
        {
            ...
            if (want.Length == 0)
            {
                Result("EB_ERR bind: cls= is REQUIRED. There is no 'try them all' mode --"
                     ...
                     + " Valid: grid|gusset|plate|shape|editconn|weldflag|posflag");
                return;
            }
