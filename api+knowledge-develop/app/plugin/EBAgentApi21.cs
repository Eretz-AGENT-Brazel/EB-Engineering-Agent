...
//   2. Python sends command  EB_RUN21
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds21))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp21))]
...
namespace EBAgent
{
    ...
    public class EBApp21 : IExtensionApplication
    {
    ...
    public class ApiCmds21
    {
        ...
        [CommandMethod("EB_RUN21", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
