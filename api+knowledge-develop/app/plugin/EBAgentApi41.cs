...
//   2. Python sends command  EB_RUN41
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds41))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp41))]
...
namespace EBAgent
{
    ...
    public class EBApp41 : IExtensionApplication
    {
    ...
    public class ApiCmds41
    {
        ...
        [CommandMethod("EB_RUN41", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
