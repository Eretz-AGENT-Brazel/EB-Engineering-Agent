...
//   2. Python sends command  EB_RUN179
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds179))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp179))]
...
namespace EBAgent
{
    ...
    public class EBApp179 : IExtensionApplication
    {
    ...
    public class ApiCmds179
    {
        ...
        [CommandMethod("EB_RUN179", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
