...
//   2. Python sends command  EB_RUN40
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds40))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp40))]
...
namespace EBAgent
{
    ...
    public class EBApp40 : IExtensionApplication
    {
    ...
    public class ApiCmds40
    {
        ...
        [CommandMethod("EB_RUN40", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
