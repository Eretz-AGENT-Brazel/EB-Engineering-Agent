...
//   2. Python sends command  EB_RUN46
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds46))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp46))]
...
namespace EBAgent
{
    ...
    public class EBApp46 : IExtensionApplication
    {
    ...
    public class ApiCmds46
    {
        ...
        [CommandMethod("EB_RUN46", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
