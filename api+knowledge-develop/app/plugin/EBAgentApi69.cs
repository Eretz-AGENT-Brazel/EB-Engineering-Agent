...
//   2. Python sends command  EB_RUN69
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds69))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp69))]
...
namespace EBAgent
{
    ...
    public class EBApp69 : IExtensionApplication
    {
    ...
    public class ApiCmds69
    {
        ...
        [CommandMethod("EB_RUN69", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
