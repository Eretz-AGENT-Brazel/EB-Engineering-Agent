...
//   2. Python sends command  EB_RUN39
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds39))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp39))]
...
namespace EBAgent
{
    ...
    public class EBApp39 : IExtensionApplication
    {
    ...
    public class ApiCmds39
    {
        ...
        [CommandMethod("EB_RUN39", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
