...
//   2. Python sends command  EB_RUN111
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds111))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp111))]
...
namespace EBAgent
{
    ...
    public class EBApp111 : IExtensionApplication
    {
    ...
    public class ApiCmds111
    {
        ...
        [CommandMethod("EB_RUN111", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
