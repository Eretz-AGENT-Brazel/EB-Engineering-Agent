...
//   2. Python sends command  EB_RUN86
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds86))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp86))]
...
namespace EBAgent
{
    ...
    public class EBApp86 : IExtensionApplication
    {
    ...
    public class ApiCmds86
    {
        ...
        [CommandMethod("EB_RUN86", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
