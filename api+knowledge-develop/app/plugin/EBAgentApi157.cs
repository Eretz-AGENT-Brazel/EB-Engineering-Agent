...
//   2. Python sends command  EB_RUN157
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds157))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp157))]
...
namespace EBAgent
{
    ...
    public class EBApp157 : IExtensionApplication
    {
    ...
    public class ApiCmds157
    {
        ...
        [CommandMethod("EB_RUN157", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
