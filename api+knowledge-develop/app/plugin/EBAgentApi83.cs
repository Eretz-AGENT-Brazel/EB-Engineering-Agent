...
//   2. Python sends command  EB_RUN83
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds83))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp83))]
...
namespace EBAgent
{
    ...
    public class EBApp83 : IExtensionApplication
    {
    ...
    public class ApiCmds83
    {
        ...
        [CommandMethod("EB_RUN83", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
