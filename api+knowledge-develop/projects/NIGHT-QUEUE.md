...
| `model 6.dwg` | partial | בנייה נקייה אחת נדרשת (הריצה נפלה על סירוב-שווא של השומר, שתוקן) ואז החלת 22 ה-polyCut מ-projects/model-6/polycuts.json ואז השערים. המצב על הדיסק: 472 פרופילים + 412 לוחות + 526 ברגים + 609 חיתוכים |
