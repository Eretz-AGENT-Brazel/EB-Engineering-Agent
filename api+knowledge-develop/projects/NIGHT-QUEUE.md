...
| `model 5_CBC TARA GELLERY.dwg` | partial | המאגר + 4 מקטעים: 175/175 פרופילים (30 ב-rot+90) · 314/314 לוחות · 126/126 חיתוכים · 821 חורים נקדחו אך 538/796 בלבד ב-0.0000 — פתוח: 112 חורים חסרים על לוחות 6מ"מ, 50 ב-U140 (דופן), 20 ב-PLATE 12; הברגים לא הוחלו בכוונה עד שהחורים מדויקים |
| `model 6.dwg` | pending |  |
