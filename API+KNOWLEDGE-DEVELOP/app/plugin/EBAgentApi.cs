...
[assembly: CommandClass(typeof(EBAgent.ApiCmds))]

namespace EBAgent
{
    public class ApiCmds
    {
        ...
        [CommandMethod("EB_RUN", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void Beam(Dictionary<string, string> kv)
        {
            ...
            // try catalogs x name variants until one creates
