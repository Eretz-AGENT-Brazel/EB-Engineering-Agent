...
//   2. Python sends command  EB_RUN68
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds68))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp68))]
...
namespace EBAgent
{
    ...
    public class EBApp68 : IExtensionApplication
    {
    ...
    public class ApiCmds68
    {
        ...
        [CommandMethod("EB_RUN68", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
