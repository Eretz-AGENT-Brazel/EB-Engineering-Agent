...
//   2. Python sends command  EB_RUN103
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds103))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp103))]
...
namespace EBAgent
{
    ...
    public class EBApp103 : IExtensionApplication
    {
    ...
    public class ApiCmds103
    {
        ...
        [CommandMethod("EB_RUN103", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        static readonly Dictionary<string, string> OpKeys = new Dictionary<string, string>()
        {
            ...
            { "ping", "||" },
            { "webangletemplates", "||" },
            { "webangle", "|at|bendradius|boltsingroup|boltstyle|catalog|cope|copetemplate|dia|eachangle|flat|fromdown|fromedge|fromhole|gap|group|handle|key|longleg|moment|nconn|nsup|nvert|pos|shear|shorten|shortleg|sideoff|slotconn|slotsup|support|template|thick|turn|vertoff|weldconn|weldsup|workloose|" },
            { "stifftemplates", "||" },
