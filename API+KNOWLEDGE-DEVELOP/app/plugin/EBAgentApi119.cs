...
//   2. Python sends command  EB_RUN119
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds119))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp119))]
...
namespace EBAgent
{
    ...
    public class EBApp119 : IExtensionApplication
    {
    ...
    public class ApiCmds119
    {
        ...
        [CommandMethod("EB_RUN119", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
