...
//   2. Python sends command  EB_RUN27
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds27))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp27))]
...
namespace EBAgent
{
    ...
    public class EBApp27 : IExtensionApplication
    {
    ...
    public class ApiCmds27
    {
        ...
        [CommandMethod("EB_RUN27", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
