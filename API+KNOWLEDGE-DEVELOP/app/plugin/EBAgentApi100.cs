...
//   2. Python sends command  EB_RUN100
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds100))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp100))]
...
namespace EBAgent
{
    ...
    public class EBApp100 : IExtensionApplication
    {
    ...
    public class ApiCmds100
    {
        ...
        [CommandMethod("EB_RUN100", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
