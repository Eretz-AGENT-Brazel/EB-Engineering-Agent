...
//   2. Python sends command  EB_RUN29
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds29))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp29))]
...
namespace EBAgent
{
    ...
    public class EBApp29 : IExtensionApplication
    {
    ...
    public class ApiCmds29
    {
        ...
        [CommandMethod("EB_RUN29", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
