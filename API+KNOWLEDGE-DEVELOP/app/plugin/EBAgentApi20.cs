...
//   2. Python sends command  EB_RUN20
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds20))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp20))]
...
namespace EBAgent
{
    ...
    public class EBApp20 : IExtensionApplication
    {
    ...
    public class ApiCmds20
    {
        ...
        [CommandMethod("EB_RUN20", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
