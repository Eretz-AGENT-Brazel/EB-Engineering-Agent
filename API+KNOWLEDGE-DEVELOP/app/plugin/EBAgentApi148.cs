...
//   2. Python sends command  EB_RUN148
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds148))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp148))]
...
namespace EBAgent
{
    ...
    public class EBApp148 : IExtensionApplication
    {
    ...
    public class ApiCmds148
    {
        ...
        [CommandMethod("EB_RUN148", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
