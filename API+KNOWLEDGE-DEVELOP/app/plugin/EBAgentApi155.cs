...
//   2. Python sends command  EB_RUN155
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds155))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp155))]
...
namespace EBAgent
{
    ...
    public class EBApp155 : IExtensionApplication
    {
    ...
    public class ApiCmds155
    {
        ...
        [CommandMethod("EB_RUN155", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
