...
//   2. Python sends command  EB_RUN120
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds120))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp120))]
...
namespace EBAgent
{
    ...
    public class EBApp120 : IExtensionApplication
    {
    ...
    public class ApiCmds120
    {
        ...
        [CommandMethod("EB_RUN120", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
