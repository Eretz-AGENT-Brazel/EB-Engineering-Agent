...
//   2. Python sends command  EB_RUN59
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds59))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp59))]
...
namespace EBAgent
{
    ...
    public class EBApp59 : IExtensionApplication
    {
    ...
    public class ApiCmds59
    {
        ...
        [CommandMethod("EB_RUN59", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
        ...
        void EdgeChamferOp(Dictionary<string, string> kv)
        {
            ...
            try
            {
                PsEdgeChamfer ec = new PsEdgeChamfer();
        ...
        static readonly Dictionary<string, string> OpKeys = new Dictionary<string, string>()
        {
            ...
            { "ping", "||" },
            { "mods", "|handle|" },
            { "edgechamfer", "|flange|handle|layout|side|v1|v2|" },
