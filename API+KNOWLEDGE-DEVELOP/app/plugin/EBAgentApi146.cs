...
//   2. Python sends command  EB_RUN146
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds146))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp146))]
...
namespace EBAgent
{
    ...
    public class EBApp146 : IExtensionApplication
    {
    ...
    public class ApiCmds146
    {
        ...
        [CommandMethod("EB_RUN146", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
