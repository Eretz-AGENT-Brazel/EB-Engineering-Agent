...
//   2. Python sends command  EB_RUN170
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds170))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp170))]
...
namespace EBAgent
{
    ...
    public class EBApp170 : IExtensionApplication
    {
    ...
    public class ApiCmds170
    {
        ...
        [CommandMethod("EB_RUN170", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
