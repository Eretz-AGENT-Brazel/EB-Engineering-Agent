...
//   2. Python sends command  EB_RUN91
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds91))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp91))]
...
namespace EBAgent
{
    ...
    public class EBApp91 : IExtensionApplication
    {
    ...
    public class ApiCmds91
    {
        ...
        [CommandMethod("EB_RUN91", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
