...
//   2. Python sends command  EB_RUN99
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds99))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp99))]
...
namespace EBAgent
{
    ...
    public class EBApp99 : IExtensionApplication
    {
    ...
    public class ApiCmds99
    {
        ...
        [CommandMethod("EB_RUN99", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
