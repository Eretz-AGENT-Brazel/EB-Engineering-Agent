...
//   2. Python sends command  EB_RUN36
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds36))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp36))]
...
namespace EBAgent
{
    ...
    public class EBApp36 : IExtensionApplication
    {
    ...
    public class ApiCmds36
    {
        ...
        [CommandMethod("EB_RUN36", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
