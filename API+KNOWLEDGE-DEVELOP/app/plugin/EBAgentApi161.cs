...
//   2. Python sends command  EB_RUN161
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds161))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp161))]
...
namespace EBAgent
{
    ...
    public class EBApp161 : IExtensionApplication
    {
    ...
    public class ApiCmds161
    {
        ...
        [CommandMethod("EB_RUN161", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
