...
//   2. Python sends command  EB_RUN48
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds48))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp48))]
...
namespace EBAgent
{
    ...
    public class EBApp48 : IExtensionApplication
    {
    ...
    public class ApiCmds48
    {
        ...
        [CommandMethod("EB_RUN48", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
