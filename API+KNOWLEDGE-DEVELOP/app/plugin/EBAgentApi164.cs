...
//   2. Python sends command  EB_RUN164
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds164))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp164))]
...
namespace EBAgent
{
    ...
    public class EBApp164 : IExtensionApplication
    {
    ...
    public class ApiCmds164
    {
        ...
        [CommandMethod("EB_RUN164", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
