...
//   2. Python sends command  EB_RUN58
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds58))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp58))]
...
namespace EBAgent
{
    ...
    public class EBApp58 : IExtensionApplication
    {
    ...
    public class ApiCmds58
    {
        ...
        [CommandMethod("EB_RUN58", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
