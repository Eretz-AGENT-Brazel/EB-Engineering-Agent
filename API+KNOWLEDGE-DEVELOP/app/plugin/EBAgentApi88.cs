...
//   2. Python sends command  EB_RUN88
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds88))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp88))]
...
namespace EBAgent
{
    ...
    public class EBApp88 : IExtensionApplication
    {
    ...
    public class ApiCmds88
    {
        ...
        [CommandMethod("EB_RUN88", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
