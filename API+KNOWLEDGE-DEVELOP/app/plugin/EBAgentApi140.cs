...
//   2. Python sends command  EB_RUN140
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds140))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp140))]
...
namespace EBAgent
{
    ...
    public class EBApp140 : IExtensionApplication
    {
    ...
    public class ApiCmds140
    {
        ...
        [CommandMethod("EB_RUN140", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
