...
//   2. Python sends command  EB_RUN147
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds147))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp147))]
...
namespace EBAgent
{
    ...
    public class EBApp147 : IExtensionApplication
    {
    ...
    public class ApiCmds147
    {
        ...
        [CommandMethod("EB_RUN147", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
