...
//   2. Python sends command  EB_RUN156
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds156))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp156))]
...
namespace EBAgent
{
    ...
    public class EBApp156 : IExtensionApplication
    {
    ...
    public class ApiCmds156
    {
        ...
        [CommandMethod("EB_RUN156", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
