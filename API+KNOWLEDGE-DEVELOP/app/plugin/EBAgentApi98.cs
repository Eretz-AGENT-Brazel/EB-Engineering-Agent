...
//   2. Python sends command  EB_RUN98
...
[assembly: CommandClass(typeof(EBAgent.ApiCmds98))]
[assembly: ExtensionApplication(typeof(EBAgent.EBApp98))]
...
namespace EBAgent
{
    ...
    public class EBApp98 : IExtensionApplication
    {
    ...
    public class ApiCmds98
    {
        ...
        [CommandMethod("EB_RUN98", CommandFlags.Modal)]
        public void Run()
        {
            var kv = ReadCmd();
            string op = Get(kv, "op", "");
